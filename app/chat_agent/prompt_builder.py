...
def build_prompt(
    ...
    if intent == "product_options":
        ...
        task = (
            ...
            "Share available phone/email/contact details directly only if present in tenant contact details or private reference. "
        ...
        reply_format = (
            ...
            "Then share phone/email/contact details if available. Never use placeholders. "
        ...
        "Include phone/email only when available in tenant contact details or private reference. "
        "If email is not available, do not mention email and do not use placeholders. "
        ...
        task = (
            ...
            "Share available contact details or relevant page/link from the provided details if available. Do not hardcode contact details. "
