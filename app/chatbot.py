...
def is_small_talk(message: str) -> bool:
    ...
    return msg in SMALL_TALK_MESSAGES
...
def chat_with_agent(session_id: str, message: str, tenant_id, top_k: int = 5) -> Dict:
    ...
    if not message:
        answer = settings.get("greeting_message") or "Hello 👋 How can I help you today?"
    ...
    # ✅ Greeting / small-talk fix
    # Do not search FAISS for hi/hello/thanks/ok etc.
    if is_small_talk(message):
        answer = settings.get("greeting_message") or f"Hello 👋 Welcome to {settings.get('business_name', 'our business')}. How can I help you today?"
    ...
    # ✅ Important: never return raw FAISS chunk to customer
    if not answer:
        answer = "I will connect you with our team."
